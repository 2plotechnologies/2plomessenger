                                        ...
                                        if(snapshot.exists()){
                                            if (snapshot.hasChild("imagen")) {
                                                ...
                                                if(privacidadimg.equals("Oculto")||privacidadimg.equals("Contacto")){
                                                    Picasso.get().load("https://firebasestorage.googleapis.com/v0/b/plo-messenger.appspot.com/o/defaultprofilephoto.png?alt=media&token=d2f0f0de-2386-45bc-952a-aedeea866b0c").into(holder.images);
                                                }else{
